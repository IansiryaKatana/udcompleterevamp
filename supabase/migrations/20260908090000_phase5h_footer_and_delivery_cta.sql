-- Unique live footer IA + published delivery copy on Unique OS chrome.
-- Does NOT flip commercial / compliance / gateway / WMS / pilot locks.
-- Does NOT restyle the Unique OS footer (dark chrome, newsletter, CMP).
...
or (location = 'footer_legal' and href in ('/pages/privacy', '/pages/cookies'));

update public.nav_links
set label = 'TPD Compliance', href = '/pages/tpd-compliance', sort_order = 0, is_active = true
where id = 'a1111111-5a00-4000-8000-000000000053';

update public.nav_links
set label = 'Terms & Conditions', href = '/pages/terms', sort_order = 1, is_active = true
where id = 'a1111111-5a00-4000-8000-000000000050';

update public.nav_links
set label = 'Modern Slavery Statement', href = '/pages/modern-slavery-statement', sort_order = 2, is_active = true
where id = 'a1111111-5a00-4000-8000-000000000054';

update public.nav_links
set label = 'Medical Info Disclaimer', href = '/pages/medical-info-disclaimer', sort_order = 3, is_active = true
where id = 'a1111111-5a00-4000-8000-000000000055';

insert into public.nav_links (id, label, href, location, sort_order, is_active)
values
  ('a1111111-5a00-4000-8000-000000000070', 'Shop by Brand', '/brands', 'footer_shop', 0, true),
  ('a1111111-5a00-4000-8000-000000000071', 'Shop by Category', '/#shop-by-category', 'footer_shop', 1, true),
  ('a1111111-5a00-4000-8000-000000000072', 'Confectionery', '/collection/confectionery', 'footer_shop', 2, true),
  ('a1111111-5a00-4000-8000-000000000073', 'Essentials', '/collection/essentials', 'footer_shop', 3, true),
  ('a1111111-5a00-4000-8000-000000000074', 'Drinks', '/collection/drinks', 'footer_shop', 4, true),
  ('a1111111-5a00-4000-8000-000000000075', 'New Arrivals', '/collection/new', 'footer_shop', 5, true),
  ('a1111111-5a00-4000-8000-000000000076', 'Best Sellers', '/collection/best', 'footer_shop', 6, true),
  ('a1111111-5a00-4000-8000-000000000080', 'About Us', '/pages/about', 'footer_company', 0, true),
  ('a1111111-5a00-4000-8000-000000000081', 'Contact Us', '/pages/contact', 'footer_company', 1, true),
  ('a1111111-5a00-4000-8000-000000000082', 'Shipping & Returns', '/pages/shipping', 'footer_company', 2, true),
  ('a1111111-5a00-4000-8000-000000000083', 'Delivery Information', '/pages/shipping', 'footer_company', 3, true),
  ('a1111111-5a00-4000-8000-000000000084', 'Privacy Policy', '/pages/privacy', 'footer_company', 4, true),
  ('a1111111-5a00-4000-8000-000000000085', 'Careers', '/pages/careers', 'footer_company', 5, true),
  ('a1111111-5a00-4000-8000-000000000090', 'Vaping vs Smoking', '/pages/vaping-vs-smoking', 'footer_help', 0, true),
  ('a1111111-5a00-4000-8000-000000000091', 'Nic Pouches in the UK', '/pages/nic-pouches-in-the-uk', 'footer_help', 1, true),
  ('a1111111-5a00-4000-8000-000000000092', 'Legal Big Puff ''Devices', '/pages/legal-big-puff-devices', 'footer_help', 2, true),
  ('a1111111-5a00-4000-8000-000000000093', 'Disposable Ban 2025', '/pages/disposable-ban-2025', 'footer_help', 3, true),
  ('a1111111-5a00-4000-8000-000000000094', 'Blogs', '/pages/blogs', 'footer_help', 4, true)
...
values
(
  'b1111111-5a00-4000-8000-000000000020',
  'Careers',
  'careers',
  $html$<p><em>Migrated from Unique Distribution’s published page at uniquedistribution.com/pages/careers. Not rewritten.</em></p>
<h2>Join Our Team</h2>
...
<p>To enquire, <a href="/pages/contact">contact Unique Distribution</a>.</p>$html$,
  'Jobs at Unique Distribution — wholesale careers in the UK.',
  true,
  30
),
(
  'b1111111-5a00-4000-8000-000000000021',
  'Vaping vs Smoking',
  'vaping-vs-smoking',
  $html$<p><em>Migrated from Unique Distribution’s published article at uniquedistribution.com/blogs/news/vaping-vs-smoking. Not rewritten.</em></p>
...
<p>Moreover, vaping offers more customization options and potentially fewer health risks than traditional cigarettes. This makes it an attractive option for those looking to quit smoking altogether.</p>$html$,
  'The Great Debate: Vaping vs Smoking — Unique Distribution news.',
  true,
  31
),
(
  'b1111111-5a00-4000-8000-000000000022',
  'Nic Pouches in the UK',
  'nic-pouches-in-the-uk',
  $html$<p><em>Migrated from Unique Distribution’s published article at uniquedistribution.com/blogs/news/the-rise-of-nicotine-pouches-in-the-uk-a-growing-trend-among-vapers. Not rewritten.</em></p>
...
<p>The rise of nicotine pouches in the UK is a testament to growing demand for alternative vaping options. Wholesale vape suppliers are well-positioned to capitalize on this trend, offering range of products that cater to diverse consumer preferences.</p>$html$,
  'The Rise of Nicotine Pouches in the UK — Unique Distribution news.',
  true,
  32
),
(
  'b1111111-5a00-4000-8000-000000000023',
  'Legal Big Puff ''Devices',
  'legal-big-puff-devices',
  $html$<p><em>Migrated from Unique Distribution’s published article at uniquedistribution.com/blogs/news/the-growing-popularity-of-legal-big-puff-devices. Not rewritten.</em></p>
...
<p>In conclusion, Legal Big Puff devices represent a significant leap forward in vaping technology. By offering rechargeable options with impressive puff counts, these innovative devices have redefined what it means to be convenient and portable.</p>$html$,
  'The Growing Popularity of Legal Big Puff Devices — Unique Distribution news.',
  true,
  33
),
(
  'b1111111-5a00-4000-8000-000000000024',
  'Disposable Ban 2025',
  'disposable-ban-2025',
  $html$<p><em>Migrated from Unique Distribution’s published article at uniquedistribution.com/blogs/news/disposable-vapes-to-be-banned-in-uk-what-you-need-to-know. Not rewritten.</em></p>
...
<p>With plenty of time before the ban takes effect in June 2025, it's recommended that you explore your options for refillable or rechargeable devices.</p>$html$,
  'Disposable Vapes to be Banned in UK: What You Need to Know — Unique Distribution news.',
  true,
  34
),
(
  'b1111111-5a00-4000-8000-000000000025',
  'Blogs',
  'blogs',
  $html$<p><em>Migrated from Unique Distribution’s published News list at uniquedistribution.com/blogs/news. Article bodies are copied onto Unique OS pages; this is not a second CMS.</em></p>
<ul>
...
<li><a href="/pages/disposable-ban-2025">Disposable Ban 2025</a></li>
  ...
  'Unique Distribution vape industry news and updates.',
  true,
  35
)
